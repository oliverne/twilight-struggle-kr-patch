...
| Phase 6 — 배포 | 사용자 안내·라이선스·배포물 정리 (zip 2종 패키징 스크립트 완료). **보류 (2026-08-13 — 한글화 마무리 후 배포는 추후 재검토)** | — | [Phase 6](phases/phase-6-release.md) |
| Phase 7 — 도움말/규칙 번역 | ✅ **완료 (2026-08-13)** — TS_RulesTutorial 313행 + 씬 규칙 문단 전량 한글화 | — | [Phase 7](phases/phase-7-help-translation.md) |

> ⚠️ **순서/상태 변경 (2026-08-13)**: Phase 7을 배포 전에 수행해 **완료**했고,
> **배포(Phase 6)는 보류** — 한글화는 파일 패치 가능 범위에서 완료. 남은 영어(턴 히스토리·튜토리얼 안내)는
> IL2CPP 코드 문자열이라 BepInEx 런타임 훅 프로젝트로만 해결 가능 (ISSUES #11·#17).
