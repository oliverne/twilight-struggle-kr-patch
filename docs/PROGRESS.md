...
| 2026-08-14                                        | **zip 레이아웃 버그 수정** — zip 내부를 `patched/<플랫폼>/` 구조로 변경 (설치 스크립트 경로와 불일치하던 버그, v0.1.0 zip 영향). `patched/windows/` 대형 에셋은 v0.1.0 릴리스 zip에서 복원. 잔재 `patched-mac/` 삭제 + gitignore 정리 | `b8ffc88` |
