...
| 2026-08-12                                        | TextAsset 미번역 전수 조사(0건) + Windows 설치 스크립트        | (이번 커밋) |
| 2026-08-12                                        | 4차 테스트 성공 — 대부분 UI·카드 한글화 확인 + 문서 갱신     | (예정)    |
| 2026-08-12                                        | 폰트 교체(Paperlogy/D2Coding) + 크기 축소 + 크기 조절 스킬 신설 | (이번 커밋) |
